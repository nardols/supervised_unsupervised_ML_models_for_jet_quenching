...
std::map<int, float> PDGCharges = {
    // ---------- Léptons ----------
    {11, -1}, {-11, +1},  // Elétron / Posítron
    {13, -1}, {-13, +1},  // Muon / Anti-Muon
    {15, -1}, {-15, +1},  // Tau / Anti-Tau
    {12,  0}, {-12,  0},  // Neutrino do elétron / Antineutrino
    {14,  0}, {-14,  0},  // Neutrino do muon / Antineutrino
    {16,  0}, {-16,  0},  // Neutrino do tau / Antineutrino

    // ---------- Quarks ----------
    {1, +2.0f/3}, {-1, -2.0f/3},   // Up
    {2, +2.0f/3}, {-2, -2.0f/3},   // Charm
    {3, -1.0f/3}, {-3, +1.0f/3},   // Strange
    {4, +2.0f/3}, {-4, -2.0f/3},   // Charm (repetido)
    ...
    // ---------- Bárions ----------
    {2212, +1}, {-2212, -1},  // Próton
    {2112, 0}, {-2112, 0},    // Nêutron
    {3122, 0}, {-3122, 0},    // Lambda
    {3222, +1}, {-3222, -1},  // Sigma±
    {3212, 0}, {-3212, 0},    // Sigma0
    {3112, -1}, {-3112, +1},  // Sigma∓
    {3312, -1}, {-3312, +1},  // Xi∓
    {3322, 0}, {-3322, 0},    // Xi0
    {3334, -1}, {-3334, +1},  // Ômega∓
